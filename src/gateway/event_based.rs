...
mod tests {
    ...
    async fn event() {
        ...
        definitions
            ...
            .unwrap()
            .establish_sequence_flow("start", "ev", "s1", None)
            .unwrap()
            .establish_sequence_flow("ev", "f1", "f1s", None)
            .unwrap()
            .establish_sequence_flow("ev", "f2", "f2s", None)
            .unwrap()
            .establish_sequence_flow("f1", "f1t", "f1s1", None)
            .unwrap()
            .establish_sequence_flow("f2", "f2t", "f2s1", None)
            .unwrap()
            .establish_sequence_flow("f1t", "end", "e1", None)
            .unwrap()
            .establish_sequence_flow("f2t", "end", "e2", None)
            .unwrap();
