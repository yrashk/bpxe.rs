...
mod tests {
    ...
    async fn fork() {
        ...
        definitions
            ...
            .unwrap()
            .establish_sequence_flow("start", "fork", "s1", None)
            .unwrap()
            .establish_sequence_flow("fork", "f1", "f1s", None)
            .unwrap()
            .establish_sequence_flow("fork", "f2", "f2s", None)
            .unwrap()
    ...
    async fn join() {
        ...
        definitions
            ...
            .establish_sequence_flow("fork", "f2", "f2s", None)
            .unwrap()
            .establish_sequence_flow("f1", "join", "j1s", None)
            .unwrap()
            .establish_sequence_flow("f2", "join", "j2s", None)
            .unwrap()
            .establish_sequence_flow("join", "f3", "f3s", None)
            .unwrap()
            .establish_sequence_flow("f3", "end", "e", None)
            .unwrap();
    ...
    async fn not_enough_to_join() {
        ...
        definitions
            ...
            .establish_sequence_flow("f1", "join", "j1s", None)
            .unwrap()
            .establish_sequence_flow("f2", "alt_end", "j2e", None)
            .unwrap()
            // EndEvent will not flow, so the join won't succeeed
            .establish_sequence_flow("alt_end", "join", "j2es", None)
            .unwrap()
            .establish_sequence_flow("join", "f3", "f3s", None)
            .unwrap()
            .establish_sequence_flow("f3", "end", "e", None)
